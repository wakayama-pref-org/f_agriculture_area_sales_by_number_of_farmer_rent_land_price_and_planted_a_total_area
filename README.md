# f_agriculture_area_sales_by_number_of_farmer_rent_land_price_and_planted_a_total_area
　【Ｆ　農業_借入れ耕地の面積別販売農家数、賃借料、農地価格、農業用機械普及台数（除く共有）、農作物の年間作付延べ面積です。】
○和歌山県統計年鑑は
和歌山県の土地、人口、経済、社会、文化など各分野にわたる統計資料を体系的に収録し、その現状と推移を明らかにしたものです。

http://www.pref.wakayama.lg.jp/prefg/020300/nenkan/2015/h27excel/f/f07-f10.xlsx
